...
import { useGetExamHistorySuspenseQuery } from '@/hooks/services/user/use-get-exam-history-query'
...
const ExamsHistoryTable = ({}: ExamsHistoryTableProps) => {
  const [params, paramsUpdater] = useApiQuery({
    sortProps: EXAM_HISTORY_SORTABLE_PROPS,
  })

  const { data } = useGetExamHistorySuspenseQuery(params)
