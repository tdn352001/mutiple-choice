        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="flex items-center space-x-2">
              <span className="block whitespace-nowrap w-full overflow-hidden text-ellipsis">{full_name}</span>
            </div>
          )
        },
        meta: {
        ...
        cell: ({ row }) => {
          return (
            <div className="min-w-28 flex items-center space-x-2">
              <span className="block whitespace-nowrap w-full overflow-hidden text-ellipsis">{row.original.email}</span>
            </div>
          )
        },
        meta: {
