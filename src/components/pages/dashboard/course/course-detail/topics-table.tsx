    ...
    () => [
      {
        ...
        header: (props) => {
          return <DataTableColumnHeader title="Topic name" {...props} />
        },
        cell: ({ row }) => {
          const { id, topic_name } = row.original
          return (
            <div className="flex items-center space-x-2">
              <Link className="line-clamp-2" href={dynamicRouters.topicById(id)}>
                {topic_name}
              </Link>
            </div>
          )
      ...
      },
      {
        ...
        header: (props) => {
          return <DataTableColumnHeader title="Topic code" {...props} />
        },
        cell: ({ row }) => {
          return (
